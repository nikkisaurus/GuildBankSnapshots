...
L["Filter loadout '%s' already exists for %s. Please supply a unique loadout name."] = true
...
L["Gold"] = true
L["Gold Deposits"] = true
L["Gold Withdrawals"] = true
L["Filter Names"] = true
...
L["Rename"] = true
L["Delete"] = true
L["Are you sure you want to delete the loadout '%s' from '%s'? This action is irreversible."] = true
